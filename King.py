# SHANI# USTAD# Ashiq# Shanibro# Gamz#!/usr/bin/python2
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Shani_Ustad
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/azan.alam.35')

    else:

        print "\033[1;94mWrong Username"

        os.syshttps://youtube.com/channel/UC2jCO2R79HWKpo3V7oVpTMA)
...
def action():
    ...
    jalan("\033[0;92mShani '")

    jalan("\033[0;92mWHATAAP")

    jalan("\033[0;92m03118066577")
